<?php 
  ...
  function getEventos($user_id){
	$sql = "SELECT eventos.titulo AS titulo, eventos.fecha_inicio AS fecha_inicial, eventos.fecha_fin AS fecha_final,
	 eventos.hora_inicio AS hora_incial, eventos.hora_fin AS hora_final, eventos.allday AS todoeldia
			FROM eventos JOIN usuario  ON eventos.fk_usuarios = usuarios.email ;";
	return $this->ejecutarQuery($sql);
  }
